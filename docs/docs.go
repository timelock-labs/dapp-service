    ...
    "paths": {
        ...
        "/api/v1/auth/wallet-connect": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "钱包连接认证请求体。必须包含从/auth/nonce获取的nonce。wallet_type可选值：'eoa'（默认）或'safe'。Safe钱包需要提供chain_id",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    ...
                    "401": {
                        "description": "认证失败，可能是签名无效、nonce过期或地址恢复失败",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/types.APIResponse"
